...
<head>
    ...
    #page-2 {
        ...
        .centered-div {
            /* Optional: tambahkan lebar dan tinggi tertentu */
            width: 100%;
            height: auto; /* Sesuaikan dengan konten */
            padding: 20px; /* Padding untuk konten dalam div */
            border-radius: 10px; /* Tambahkan radius untuk estetika */
        }
        .a4 {
            width: 297mm; /* 297mm */
            height: 210mm;
