        ...
        <div class="fnt">
            <table>
                    ...
                    <tr>
                        ...
                        <td class="fntb pdtb fontl hide" colspan="5"><input type="text" name="nopol" style="width: 80px; height: 14px; font-size: 11px" class="fnt" required oninput="this.value = this.value.toUpperCase();"></td>
                    ...
                    <tr>
                        ...
                        <td class="fntb pdtb hide">:</td>
                        <td class="fntb pdtb fontl hide" colspan="11"><input type="text" name="pengemudi" style="width: 80px; height: 14px; font-size: 11px" class="fnt" required oninput="this.value = this.value.toUpperCase();"></td>
                    </tr>
                    {{-- row 12 --}}
                    <tr>
