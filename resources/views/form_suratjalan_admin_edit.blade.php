...
<body>
    <div class="fnt">
        <form action="{{ route('storedatasuratadmin') }}" method="POST">
            @csrf
            <table>
                {{-- row 0, 15 column --}}
                <tr>
                ...
                <tr>
                    ...
                    <td class="fntb bdottb pdtb fnt12 itmth" colspan="2">
                        ...
                        @else
                        <input name="jumlahdiberi[]" type="text" value="{{ $item->jumlah_diberi}}" style="width: 70px; text-align: center" class="fnt" required oninput="this.value = this.value.toUpperCase();">
                        @endif                        
                    </td>
            ...
            <div class="d-flex justify-content-end">
                <button class="btn btn-primary mt-5" type="submit" target="">Simpan</button>
            </div>
        </form>
    </div>
</body>
