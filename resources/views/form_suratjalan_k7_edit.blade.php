        ...
        <div class="fnt">
            <table>
                    ...
                    <tr>
                        ...
                        <td class="fntb pdtb fontl hide" colspan="5">
                            @if($sj->nomor_polisi === null)
                            <input type="text" name="nopol" style="width: 80px; height: 14px; font-size: 11px" class="fnt" required oninput="this.value = this.value.toUpperCase();"></td>
                            @else
                            <input type="text" name="nopol" value="{{ $sj->nomor_polisi}}" style="width: 80px; height: 14px; font-size: 11px" class="fnt" required oninput="this.value = this.value.toUpperCase();"></td>
                            @endif                            
                    ...
                    <tr>
                        ...
                        <td class="fntb pdtb hide">:</td>
                        <td class="fntb pdtb fontl hide" colspan="11">
                            @if ($sj->pengemudi == null)
                            <input type="text" name="pengemudi" style="width: 80px; height: 14px; font-size: 11px" class="fnt" required oninput="this.value = this.value.toUpperCase();"></td>
                            @else
                            <input type="text" name="pengemudi" value="{{ $sj->pengemudi }}" style="width: 80px; height: 14px; font-size: 11px" class="fnt" required oninput="this.value = this.value.toUpperCase();"></td>    
                            @endif                            
                    </tr>
                    {{-- row 12 --}}
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="fntb hide fontl" colspan="5">{{ \Carbon\Carbon::parse($sj->tgldicetak)->translatedFormat('d F Y') }}</td>
                    </tr>
