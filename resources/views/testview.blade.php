...
<body>
    <div class="row" style="width: 100%">
            ...
            <div class="card" id="floater">
                <div class="card-body">
                    ...
                    <tbody id="dpmOngoing">
                        ...
                        <tr>                        
                            <td>{{ $item->tgl_diubah }}</td>
                            <td>{{ $item->nama }}</td>
                            <td>{{ $item->jumlah_sebelumnya }}</td>
                            <td>{{ $item->jumlah_ditambah }}</td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="4" style="text-align: center">Belum ada data yang diubah</td>
                        </tr>
                        @endforelse
                    </tbody>
                    </table>
        ...
        <div class="col-2" style="width: 210mm; size: A4">
            <div class="fnt mt-3 mb-3">
                <table>
                    {{-- row 0, 15 column --}}
                    <tr>
