                                ...
                                <div class="card-body">
                                    ...
                                    <script>
                                        document.addEventListener("DOMContentLoaded", () => {
                                            // const materialData = @json($materialStats['perBagian']);
                                            ...
                                            new Chart(document.querySelector('#barChart'), {
                                                ...
                                                data: {
                                                    labels: [
                                                        ...
                                                        'K7',
                                                        'K3',
                                                        ...materialData.map(item => `Material ${item.bagian}`)
                                                    ],
                                                    datasets: [{
                                                        barThickness: 75,
                                                        data: [{
                                                            ...
                                                            ...materialData.map(item => item.jumlah)
                                                        ],
                                                        backgroundColor: [
                                                            'rgba(255, 99, 132, 0.2)', // DPM
                                                            'rgba(255, 159, 64, 0.2)', // K7
                                                            'rgba(255, 205, 86, 0.2)', // K3
                                                            'rgba(75, 192, 192, 0.2)', // Material 1
                                                            'rgba(54, 162, 235, 0.2)', // Material 2
                                                            'rgba(153, 102, 255, 0.2)', // Material 3
                                                            'rgba(201, 203, 207, 0.2)' // Material 4
                                                        ],
                                                        borderColor: [
                                                            'rgb(255, 99, 132)',
                                                            'rgb(255, 159, 64)',
                                    ...
                                    <div class="mt-4">
                                        <h6>Total Material: {{ $materialStats['total'] }}</h6>
                                        <div class="row mt-3">
                                            @foreach($materialStats['perBagian'] as $stat)
                                            <div class="col-md-4 mb-2">
                                                <div class="card">
                                                    <div class="card-body p-3">
                                                        <h6 class="card-title">{{ $stat->nama }}</h6>
                                                        <p class="card-text mb-0">Jumlah: {{ $stat->jumlah }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            @endforeach
