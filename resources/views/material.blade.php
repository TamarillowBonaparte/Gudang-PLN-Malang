...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col d-flex justify-content-end">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#tmbhMat"><i class="bi bi-plus"></i>Tambah Material Baru</button>
                    </div>
                </div>
            </nav>
        </div><!-- End Page Title -->
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Search bar dan entries dropdown -->
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div>
                                    <label for="entriesMaterialKeluar" class="form-label mb-0">Entries:</label>
                                    <select id="entriesMaterialKeluar" class="form-select d-inline-block"
                                        style="width: auto;">
                                ...
                                <div>
                                    <label for="searchMaterialKeluar" class="form-label mb-0">Search:</label>
                                    <input type="text" id="searchMaterialKeluar" class="form-control d-inline-block"
                                        style="width: 250px;" placeholder="Mencari...">
                                </div>
                            </div>
                            <!-- Table with stripped rows -->
                            <table class="table" id="tableMaterialKeluar">
                                <thead>
                                    <tr>
                                        <th>Nama Material</th>
                                        <th>Jumlah</th>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div>
                                    <label for="entriesMaterialMasuk" class="form-label mb-0">Entries:</label>
                                    <select id="entriesMaterialMasuk" class="form-select d-inline-block"
                                        style="width: auto;">
                                        <option value="5">5</option>
                                        <option value="10" selected>10</option>
                                        <option value="20">20</option>
                                ...
                                <div>
                                    <label for="searchMaterialMasuk" class="form-label mb-0">Search:</label>
                                    <input type="text" id="searchMaterialMasuk"
                                        class="form-control d-inline-block" style="width: 250px;"
                                        placeholder="Mencari...">
                                </div>
                            </div>
                            <!-- Table with stripped rows -->
                            <table class="table" id="tableMaterialMasuk">
                                <thead>
                                    <tr>
                                        <th>Nama Material</th>
                                        <th>Jumlah</th>
    ...
    <!-- End Material Masukk -->
        ...
        <div class="modal fade" id="tmbhMat" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('materialBaru') }}" method="POST">
                            ...
                            <div class="form-group row mb-2" id="perinput">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="namaMat" name="namaMat" class="form-control"
                                        autocomplete="off">
                                </div>
                            </div>

                            <div class="form-group row mb-2" id="perinput">
                                <label class="col-sm-3 col-form-label">Normalisasi:<span
                                        style="color: red;">*</span></label>
                                <div class="col-sm-9">
                                    <input type="number" id="normalisasi" name="normalisasi" class="form-control"
                                        autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-2" id="perinput">
                                <label class="col-sm-3 col-form-label">Satuan:<span
                                        style="color: red;">*</span></label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row" id="perinput">
                                <label class="col-sm-3 col-form-label">Jumlah SAP:<span
                                        style="color: red;">*</span></label>
                                <div class="col-sm-9">
                                    <input type="number" id="jlmh" name="jumlah_sap" class="form-control"
                                        autocomplete="off">
                                </div>
                            </div>
        ...
        <div class="modal fade" id="edittmbh" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="{{ route('tambahmaterial') }}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="tambahmaterial" id="tambahmaterial"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="modalNormalisasi"
                                        name="modalNormalisasi">
                                </div>
                            </div>
    ...
    <!--Script search buat materiall--->
    <script>
        $(document).ready(function() {
            // Inisialisasi tabel Material Keluar
            function initMaterialKeluarTable() {
                const table = $("#tableMaterialKeluar tbody");
                const rows = table.find("tr");
                let perPage = 10;

                // Fungsi untuk render tabel sesuai filter dan pagination
                function renderTable() {
                    const searchQuery = $("#searchMaterialKeluar").val().toLowerCase();
                    ...
                    const start = 0;
                    const end = perPage;
                    table.html(filteredRows.slice(start, end));
                }

                // Event listener untuk search
                $("#searchMaterialKeluar").on("keyup", function() {
                    renderTable();
                });

                // Event listener untuk entries dropdown
                $("#entriesMaterialKeluar").on("change", function() {
            ...
            initMaterialKeluarTable();
        });
    </script>

    <script>
        $(document).ready(function() {
            function initTable(tableId, searchId, entriesId) {
                const table = $(`#${tableId} tbody`);
                const rows = table.find("tr");
                let perPage = 10;

                function renderTable() {
                    const searchQuery = $(`#${searchId}`).val().toLowerCase();
                    const filteredRows = rows.filter(function() {
                        const rowText = $(this).text().toLowerCase();
                        return rowText.includes(searchQuery);
                    });

                    table.html(filteredRows.slice(0, perPage));
                }
            ...
            initTable("tableMaterialKeluar", "searchMaterialKeluar", "entriesMaterialKeluar");
            initTable("tableMaterialMasuk", "searchMaterialMasuk", "entriesMaterialMasuk");
        });
    </script>

    <!--End Script search buat materiall--->
    <!-- ======= Footer ======= -->
    @include('footer')
